 ...
 * @extends lime.Button
 */
strikeout.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#000');
};
goog.inherits(strikeout.Button, lime.GlossyButton);

/**
 * @inheritDoc
 */
strikeout.Button.prototype.makeState_ = function() {
    var state = new lime.RoundedRect().setFill('#ccc').setRadius(10);
 ...
 * @inheritDoc
 */
strikeout.Button.prototype.setColor = function(clr) {
